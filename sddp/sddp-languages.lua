...
dictionary = {
    tab_solution_quality = {
        en = "Solution quality",
        es = "Calidad de la solución",
        pt = "Qualidade da solução"
    },
    tab_policy = {
        en = "Policy",
        es = "Política",
    ...
    number_of_added_cut = {
        en = "Number of added cuts",
        es = "Número de cortes adicionados",
        pt = "Número de cortes adicionados"
    },
    violation_penalties = {
    ...
    convergence_map = {
        en = "Convergence map",
        es = "Mapa de convergencia",
        pt = "Mapa de convergência"
    },    
    solution_status = {
        en = "Solution status per stage and scenario",
    ...
    exe_pol_times = {
        ...
        es = "Tiempo de ejecución política",
    ...
    annual_cmo = {
        ...
        pt = "Custo marginal anual por sistema"
    },
    stg_cmo = {
        en = "Average marginal costs per stage per system",
    ...
    total_generation_system = {
        en = "Total generation per system",
        es = "Generación total por sistema",
        pt = "Geração total por sistema"
    },
    defcit = {
        en = "Deficit",
        es = "Déficit",
    ...
    hydro_controllable_spillage_violation = {
        ...
        pt = "Hidro: vertimento controlável"
    },
    ...
    vsecset = {
        ...
        es = "Conjunto de embalses: restricción de energía de seguridad",
        pt = "Conjunto de reservatórios: restrição de energia de segurança"
    },
    valeset = {
        en = "Reservoir set: alert energy constraint",
        es = "Conjunto de embalses: restricción de energía de alerta",
...
non_convexities_labels = {
    ['Hydro plants with variable production coefficient'] = 'Hydro plants with variable production coefficient',
    ['Hydro plants with evaporation variable with the area'] = 'Hydro plants with evaporation variable with the area',
    ['Hydro plants with infiltration variable with the storage'] = 'Hydro plants with infiltration variable with the storage',
    ...
    ['Centrales hidroelectricas con infiltracion variable con el volumen'] = 'Centrales hidroeléctricas con infiltración variable según el volumen',
    ...
    ['Centrales hidroelectricas con commitment'] = 'Centrales hidroeléctricas con unit commitment',
    ...
    ['Usinas hidroeletricas com vertimento nao-controlavel (penalizado)'] = 'Usinas hidrelétricas com vertimento não controlável (penalizado)',
    ['Usinas hidroeletricas com vertimento nao-controlavel (var. inteira)'] = 'Usinas hidrelétricas com vertimento não controlável (var. inteira)',
    ...
    ['Usinas hidroeletricas com representacao de queda liquida (v. inteira)'] = 'Usinas hidrelétricas com representação de queda líquida (v. inteira)',
