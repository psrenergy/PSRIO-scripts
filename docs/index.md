...
## Welcome to PSRIO Scripts

PSRIO is a domain-specific language designed for managing data held in PSR databases. The idea is to query output data of PSR models, perform several user-specified mathematical, statistical, and data processing operations and finally produce new customized outputs in the same format as the SDDP outputs that can be processed by the graph tool Additionally, PSRIO also enables the direct creation of dashboard.
