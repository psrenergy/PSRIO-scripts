...
PSRIO provides a set of methods that allow users to plot their results in a simple and easy way.
...
Charts are the basic elements of dashboards. They provide a visual way of analysing the data generated by PSR models. To create a chart object, we should use one of the following methods:
